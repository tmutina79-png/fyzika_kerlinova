...
<body>
  ...
  <div class="example">
    ...
    <div class="example-task">
      <strong>📝 Zadání:</strong> Dva sousedé (domy A a B) chtějí vykopat společnou studnu tak, aby byla od obou domů stejně daleko. Kde může studna ležet?
    </div>
    <div class="solution-space">
      <div class="solution-label">Řešení:</div>
  ...
  <div class="example">
    ...
    <div class="example-task">
      <strong>📝 Zadání:</strong> WiFi router má dosah 15 metrů. Router je umístěn uprostřed obývacího pokoje. Kde všude bude signál dostupný?
    </div>
    <div class="solution-space">
      <div class="solution-label">Řešení:</div>
      <div class="solution-lines"></div>
  ...
  <div class="example">
    ...
    <div class="example-task">
      <strong>📝 Zadání:</strong> Podél železniční tratě (přímky p) se nesmí stavět blíže než 50 metrů. Kde přesně je hranice, za kterou už stavět lze?
    </div>
    <div class="solution-space">
      <div class="solution-label">Řešení:</div>
      <div class="solution-lines"></div>
  ...
  <div class="example">
    ...
    <div class="example-task">
      <strong>📝 Zadání:</strong> Rozhodčí chce stát tak, aby měl stejný výhled na obě branky (body A a B). Kde se má postavit?
    </div>
    <div class="solution-space">
      <div class="solution-label">Řešení:</div>
      <div class="solution-lines"></div>
  ...
  <div class="example">
    ...
    <div class="example-task">
      <strong>📝 Zadání:</strong> Na rohu budovy (kde se stýkají dvě zdi p a q) má být umístěna bezpečnostní kamera tak, aby sledovala obě zdi stejně. Kam ji umístit?
    </div>
    <div class="solution-space">
      <div class="solution-label">Řešení:</div>
      <div class="solution-lines"></div>
  ...
  <div class="example">
    ...
    <div class="example-task">
      <strong>📝 Zadání:</strong> Piráti ukryli poklad přesně 100 kroků od starého dubu (bod D) a zároveň 80 kroků od skály (bod S). Kde může poklad být, pokud víme, že |DS| = 120 kroků?
    </div>
    <div class="solution-space">
      <div class="solution-label">Řešení:</div>
      <div class="solution-lines"></div>
  ...
  <div class="footer">
    © Studijní portál · Množina bodů daných vlastností
  </div>
